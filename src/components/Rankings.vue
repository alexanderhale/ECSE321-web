		...
		<b-container fluid class="filter-inputs">
			<b-row class="input">
				<b-col sm="3"><label for="start-date">Start date:</label></b-col>
      			<b-col sm="9"><b-form-input id="start-date" type="date"></b-form-input></b-col>
			</b-row>
			<b-row class="input">
				<b-col sm="3"><label for="end-date">End date:</label></b-col>
      			<b-col sm="9"><b-form-input id="end-date" type="date"></b-form-input></b-col>
			</b-row>
		</b-container>
